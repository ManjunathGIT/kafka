...
class RichProducerConfig(props: Properties) extends AsyncProducerConfig(props)  {
  /** the partitioner class for partitioning events amongst sub-topics */
  val partitionerClass = Utils.getString(props, "partitioner.class")

  /** root topic whose sub topics represent the partitions */
  val rootTopic = Utils.getString(props, "root.topic")
